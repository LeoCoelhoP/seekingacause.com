...
import {
	ADD_PHONE_NUMBER_BUTTON_TEXT,
	CLOSE_BUTTON_TEXT,
	MODAL_DESCRIPTION,
	MODAL_TITLE,
	PHONE_NUMBER_PLACEHOLDER,
} from '../Constants/PhoneNumberModal';
	...
	return (
		<div className='modal z-20 h-[calc(100% - 20px)] blur-none overflow-y-scroll absolute w-5/6 text-neutral-950 font-semibold drop-shadow-2xl shadow-2xl rounded-md bg-neutral-50 p-4 mx-auto my-auto flex flex-col gap-2 items-center justify-center'>
			...
			<img
				...
				alt='WhatsApp Popup'
			/>
			<p>{i18next.t('PHONE_MODAL_DESCRIPTION')}</p>
			<form className='w-full'>
				<label className='w-full'>
					...
					<input
						...
						value={phoneNumber}
						placeholder={i18next.t('PHONE_MODAL_PHONE_NUMBER_PLACEHOLDER')}
					/>
			...
			<div className='flex w-full gap-2'>
				...
				<Button
					...
					textSize='text-sm'>
					{i18next.t('PHONE_MODAL_ADD_PHONE_NUMBER_BUTTON_TEXT')}
				</Button>
			</div>
		</div>
	);
