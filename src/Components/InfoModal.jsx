...
export default function InfoModal() {
	...
	return (
		<div className='absolute z-20 flex flex-col items-center justify-center w-5/6 gap-2 p-4 mx-auto my-auto overflow-y-scroll font-semibold rounded-md shadow-2xl md:overflow-hidden modal h-5/6 blur-none text-neutral-950 drop-shadow-2xl bg-neutral-50'>
